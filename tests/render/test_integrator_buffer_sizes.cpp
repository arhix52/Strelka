...
TEST_CASE("wavefrontBufferLayout scales with pixel count")
{
    ...
    CHECK(nee.restirTargetSurfaceBytes == 0);
...
TEST_CASE("ReSTIR scratch reservoir fits in hit storage")
{
    ...
    CHECK(nee.hitBytes == size_t{ 320 } * 240 * 24);
}
